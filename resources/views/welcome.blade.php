...
<!-- ======= Section: Barang Bekas Terbaru ======= -->
<section id="barang-bekas" class="py-5 bg-light">
  <div class="container" data-aos="fade-up">
    <div class="section-header">
      <h2>Barang Bekas Terbaru</h2>
      <p>Lihat koleksi barang bekas yang tersedia saat ini</p>
    </div>
    <div class="row gy-4">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card h-100 shadow-sm">
            <div class="card-body">
              ...
              <span class="badge bg-secondary">{{ $item->kategori->nama ?? 'Tanpa Kategori' }}</span>
            </div>
          </div>
        </div>
      @empty
    ...
    <div class="row gy-4">
      @forelse ($barang as $item)
        <div class="col-lg-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="200">
          <div class="service-item position-relative card w-100 shadow-sm">
            <div class="card-body">
              <h5 class="card-title">{{ $item->nama }}</h5>
